<template>
  <article class="container py-12 wysiwyg lg:pt-32">
    <div class="max-w-4xl">
      ...
      <p>
        <em>W. CLASSEN GmbH &amp; Co. KG</em><br /><em>Werner-von-Siemens-Strasse 18-20</em><br /><em
          >D-56759 Kaisersesch</em
        ><br /><em>Tel: +49 2653-980-0</em><br /><em>E-Mail: info@classen.de</em>
      </p>
      <p>
        <em>Geschäftsführer:</em><br /><em
          >Dr. Hans-Jürgen Hannig, Stefanie Quervel, Tobias Hannig, Arne Loebel, Jürgen Resch</em
        >
      </p>
      <p><em>Handelsregister:</em><br /><em>Amtsgericht Koblenz HRB 4799</em><br /><em>USt-Id: DE 123 507 902</em></p>
      <h2>Name und Anschrift des Datenschutzbeauftragten</h2>
      <p>Der Datenschutzbeauftragte des Verantwortlichen ist:</p>
      <p>
        <em>Klaus Keukert</em><br /><em>S&amp;L ITcompliance</em><br /><em>Florinstraße 18, 56218 Mülheim-Kärlich</em
        ><br /><em>E-Mail: kkeukert@sul.de</em><br /><em>Website: www.sul.de</em>
      </p>
      ...
      <p>
        ...
        seine Einwilligung zur Verarbeitung der in diesem Zusammenhang verwendeten personenbezogenen Daten eingeholt. In
        diesem Zusammenhang erfolgt auch ein Hinweis auf diese Datenschutzerklärung.
      </p>
      ...
      <p>
        ...
        Die Rechtsgrundlage für die Verarbeitung personenbezogener Daten unter Verwendung von Cookies zu Analysezwecken
        ist bei Vorliegen einer diesbezüglichen Einwilligung des Nutzers Art. 6 Abs. 1 lit. a DSGVO.
      </p>
      ...
      <p>
        ...
        genutzt werden kann. Nimmt ein Nutzer diese Möglichkeit wahr, so werden die in der Eingabemaske eingegeben Daten
      ...
      <p>Sie können an info@classen.de jederzeit den Wiederruf richten.</p>
      <p>
      ...
      <p>
        Das Unternehmen verwendet für die Website <a href="http://www.classen.de">www.classen.de</a> Google Analytics,
        einen Webanalysedienst der Google Inc. („Google“). Google Analytics verwendet sog. „Cookies“, Textdateien, die
        auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen. Die
        durch den Cookie erzeugten Informationen über Ihre Benutzung dieser Website werden in der Regel an einen Server
        von Google in den USA übertragen und dort gespeichert. Im Falle der Aktivierung der IP-Anonymisierung auf dieser
        Webseite, wird Ihre IP-Adresse von Google jedoch innerhalb von Mitgliedstaaten der Europäischen Union oder in
        ...
        Betreibers dieser Website wird Google diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten, um
      ...
      <p>
        Das Unternehmen verwendet auf der Website <a href="http://www.classen.de">www.classen.de</a> an
        unterschiedlichen Stellen eigene Cookies, die dazu dienen, das Angebot der Classen Gruppe anwendungsfreundlicher
        zu gestalten. Jedem Nutzer steht es frei, die Installation derartiger Cookies durch eine entsprechende
        Einstellung seines Browsers zu verhindern. Das Unternehmen weist allerdings darauf hin, dass der Nutzer bei
        einer derartigen Einstellung gegebenenfalls nicht sämtliche Funktionen der Website
        <a href="http://www.classen.de">www.classen.de</a> vollumfänglich nutzen kann.
      </p>
      <h2>Datenschutzerklärung für die Nutzung Google AdWords</h2>
      <p>
        Wir nutzen auf unserer Webseite mit Google AdWords ein Online-Werbeprogramm der Google Inc. Dabei wird auch das
        Conversion-Tracking eingesetzt. Mit diesem Tool setzt Google AdWords ein Cookie auf Ihrem PC, wenn Sie über eine
        Google-Werbeanzeige auf unsere Webseite kommen. Das Cookie hat nach 30 Tagen keine Gültigkeit mehr. Es dient
        keiner persönlichen Rückverfolgbarkeit. Besuchen Sie als Nutzer unsere Webseite und das Cookie arbeitet noch,
        wird für uns gemeinsam mit Google erkennbar, dass Sie auf die entsprechende Anzeige geklickt haben und zu
        unserer Seite weitergeleitet wurden. Dabei wird jedem Google AdWords-Kunden ein anderes Cookie zugewiesen.
        Cookies sind so nicht über die Webseiten der AdWords-Kunden nachverfolgbar. Mit den durch Conversion-Cookies
        eingeholten Daten werden Conversion-Statistiken für AdWords-Kunden erstellt. Wir als Kunden erfahren so die
        Gesamtanzahl der Nutzer, die auf unsere Anzeige reagiert haben und dann zu einer Webseite durchgeleitet wurden,
        die mit einem Conversion-Tracking-Tag versehen wurde. Wir erhalten bei diesem Vorgang keine Informationen, mit
        denen wir Sie als Nutzer persönlich identifizieren könnten. Sollten Sie das Tracking-Verfahren ablehnen, lässt
        sich das Cookie des Google-Conversion-Trackings über Ihren Internet-Browser deaktivieren. Nutzen Sie
        gegebenenfalls die Hilfe-Funktion des Browsers für weitere Informationen. Näheres zu den Datenschutzbestimmungen
        von Google erfahren Sie unter www.google.de/policies/privacy.
      </p>
      ...
      <p>
        ...
        Google Inc., ansässig in den USA, CA 94043, 1600 Amphitheatre Parkway, Mountain View. Indem Sie Google Maps auf
        unserer Webseite nutzen, werden Informationen über die Nutzung dieser Webseite und Ihre IP-Adresse an einen
      ...
      <p>
        ...
        Google gespeichert. Nähere Informationen finden Sie in den Datenschutzhinweisen von Google, die Sie hier abrufen
        können:<br />
      ...
      <p>
        Die Internetseite <a href="http://www.classen.de">www.classen.de</a> bietet Ihnen als zusätzlichen Service
        sogenannte Social Buttons, die eine Interaktion mit sozialen Diensten ermöglichen. Um eine ungewünschte
        Übertragung Ihrer Nutzungsdaten (z.B. Adresse der aktuell besuchten Seite) an diese Dienste zu verhindern,
        kommen Sie erst mit Klick auf den Link zu den Diensten (Social-Media-Buttons). Auf der jeweiligen Diensteseite
        können diese genannten sozialen Netzwerke Nutzungs- und u.U. Nutzerdaten erheben. Inwiefern diese Daten erhoben
        und ausgewertet werden, kann vom Unternehmen nicht beeinflusst werden.
      </p>
      <p>
        Daher informieren wir Sie entsprechend unserem Kenntnisstand:<br />
        Erst beim Aufruf der Links stellt Ihr Browser unter Umständen eine direkte Verbindung mit den Servern der
        genannten Dienste her. Hierdurch wird die Information, dass Sie die Website des Unternehmens besucht haben,
        indirekt (Referrer) an diese Dienste weitergeleitet. Sofern Sie während des Besuchs der Website
        <a href="http://www.classen.de">www.classen.de</a> bereits mit Ihrem persönlichen Benutzerkonto bei dem Dienst
        eingeloggt sind, können Sie in der Regel nach anklicken der Social-Buttons das Dokument „Teilen“ (sog.
        „Sharing“) oder einen Kommentar hinterlassen etc. Wenn Sie eine solche Datenübermittlung nicht wünschen, rät Das
        Unternehmen vom Anklicken der Social-Buttons ab.
      </p>
      <p>
        Zweck und Umfang der Datenerhebung durch die sozialen Dienste, sowie die dortige weitere Verarbeitung und
        Nutzung Ihrer Daten wie auch Ihre diesbezüglichen Rechte und Einstellungsmöglichkeiten zum Schutz Ihrer
        Privatsphäre entnehmen Sie bitte den Datenschutzhinweisen dieser Dienste.
      </p>
      <h2>Facebook</h2>
      <p>
        Auf den Internetseiten des Unternehmens werden Plugins des sozialen Netzwerkes facebook.com verwendet, das von
        der Facebook Inc., 1601 S. California Ave, Palo Alto, CA 94304, USA betrieben wird („Facebook“).
      </p>
      <p>
        Wenn Sie mit einem solchen Plugin versehene Internetseiten der Internetpräsenz aufrufen, wird eine Verbindung zu
        den Facebook-Servern hergestellt und dabei das Plugin durch Mitteilung an Ihren Browser auf der Internetseite
        dargestellt. Hierdurch wird an den Facebook-Server übermittelt, welche Internetseiten des Unternehmens Sie
        besucht haben. Sind Sie dabei als Mitglied bei Facebook eingeloggt, ordnet Facebook diese Information Ihrem
        persönlichen Facebook-Benutzerkonto zu. Bei der Nutzung der Plugin-Funktionen (z.B. Anklicken des „Gefällt
        mir“-Buttons, Abgabe eines Kommentars) werden auch diese Informationen Ihrem Facebook-Konto zugeordnet, was Sie
        nur durch Ausloggen vor Nutzung des Plugins verhindern können.
      </p>
      <p>
        Nähere Informationen zur Erhebung und Nutzung der Daten durch Facebook, über Ihre diesbezüglichen Rechte und
      ...
      <p>
        ...
        einsehbares Tagebuch im Internet definiert. Unternehmen und Pressemedien nutzen Twitter als Plattform zur
        Verbreitung von Nachrichten. Wird der Twitter-Button vom registrierten Nutzer aufgerufen, kann er diese Seite
        weiter „twittern“ und dazu noch einen persönlichen Text in der Länge von 140 Zeichen hinzufügen. Twitter sammelt
        personenbezogene Daten seiner Benutzer und teilt sie Dritten mit. Twitter sieht diese Informationen als einen
        Aktivposten und behält sich das Recht vor, sie zu verkaufen, wenn die Firma den Besitzer wechselt. Unklar ist
        momentan insbesondere noch die Frage, ob der Twitter-Button auch personenbezogene Daten von Webseiten-Besuchern
        an Twitter.com übermittelt, die nicht Mitglieder bei Twitter sind.
      </p>
      <h2>Google+</h2>
      <p>
        Unsere Seiten nutzen Funktionen von Google+. Anbieter ist die Google Inc., 1600 Amphitheatre Parkway Mountain
        ...
        veröffentlichen. Über die Google+-Schaltfläche erhalten Sie und andere Nutzer personalisierte Inhalte von Google
        und unseren Partnern. Google speichert sowohl die Information, dass Sie für einen Inhalt +1 gegeben haben, als
        auch Informationen über die Seite, die Sie beim Klicken auf +1 angesehen haben. Ihre +1 können als Hinweise
        zusammen mit Ihrem Profilnamen und Ihrem Foto in Google-Diensten, wie etwa in Suchergebnissen oder in Ihrem
        Google-Profil, oder an anderen Stellen auf Websites und Anzeigen im Internet eingeblendet werden.<br />
        Google zeichnet Informationen über Ihre +1-Aktivitäten auf, um die Google-Dienste für Sie und andere zu
        verbessern. Um die Google+-Schaltfläche verwenden zu können, benötigen Sie ein weltweit sichtbares, öffentliches
      ...
      <ol>
        ...
        <li>
          ...
          feststeht, ob die berechtigten Gründe des Verantwortlichen gegenüber Ihren Gründen überwiegen.<br />
...
<style scoped>
article {
  counter-reset: privacy-main-section;
}

h2 {
  counter-reset: privacy-sub-section;
}
